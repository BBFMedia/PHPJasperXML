...
// calc height
                ...
                $this->_output->MultiCell($arraydata["width"], $arraydata["height"], $this->formatText($txt, $arraydata["pattern"]), $arraydata["border"], $arraydata["align"], $arraydata["fill"], 1, '', '', true, 0, true, true, $maxheight);
                if ($this->_output->balancetext() == '' && $this->currentband == 'detail') {
                    if ($this->maxpagey['page_' . ($this->_output->getPage() - 1)] == '')
                        $this->maxpagey['page_' . ($this->_output->getPage() - 1)] = $this->_output->GetY();
                    else {
